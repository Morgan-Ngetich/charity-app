"""Initial migrationsss

Revision ID: 198414c69c3a
Revises: 
Create Date: 2024-03-20 09:37:39.210933
...
def upgrade():
    ...
    sa.Column('charity_email', sa.String(), nullable=False),
    sa.Column('map_details', sa.String(), nullable=True),
    sa.Column('date', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['charity_id'], ['charities.charity_id'], ondelete='CASCADE'),
    ...
    sa.ForeignKeyConstraint(['contact_details_id'], ['contact_details.id'], ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
